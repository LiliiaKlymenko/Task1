...
public class Task2 {
     ...
     */
    public static String minimumDifferentNumbers(int[] array) {
	...
	return "Minimum different numbers consist: " + Collections.max(k.keySet())
		+ " (diff. numbers: " + k.get(Collections.max(k.keySet())) + ")";
    }
     ...
     */
    public static void onlyEven(int[] array) {
	int count = 0;
	int countOdd = 0;
	int countEven = 0;
